        ...
        try:
            ...
            if is_authenticated:
                ...
                """, (user_id, 'combined_features', json.dumps({
                    ...
                    'feature_names': []  # We don't need to store feature names for new patterns
                })))
...
def index():
    ...
    return jsonify({
        'status': 'success',
        'message': 'Behavioral Biometric Authentication API',
        'endpoints': {
...
if __name__ == '__main__':
    print("🚀 Starting Behavioral Biometric Authentication Server...")
